...
*/
let cars =['Ford','Honda','Subaru','Geo']
...
*/
let moreCars=['BMW','Buick','Acura','Honda']
...
console.log("totalCars.join(',')="+stringOfCars)
...
console.log('convert stringOfCars into array called totalCars='+totalCars)
...
*/
console.log(carsInReverse.sort().indexOf('Acura'))
...
let removedCars=carsInReverse.slice(carsInReverse.indexOf('Ford'), carsInReverse.indexOf('Ford')+1)
removedCars = removedCars.concat(carsInReverse.slice(carsInReverse.indexOf('Honda'), carsInReverse.indexOf('Honda')+1))
...
*/
console.log(carsInReverse.unshift('Daewoo'))
console.log(carsInReverse)
